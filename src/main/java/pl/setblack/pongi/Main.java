...
import pl.setblack.pongi.scores.repo.ScoresRepositoryES;
...
public class Main {
    ...
    public static void main(final String ... args ) throws  Exception{
        ...
        final ScoresRepositoryNonBlocking scoresRepo = new ScoresRepositoryNonBlocking(new ScoresRepositoryES());
